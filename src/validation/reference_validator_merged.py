...
class ReferenceValidator:
    ...
    def generate_validation_report(self) -> None:
        ...
        report_title = "ENHANCED DOCUMENT REFERENCE VALIDATION REPORT" if self.enhanced_mode else "DOCUMENT REFERENCE VALIDATION REPORT"
...
def main() -> None:
    ...
    parser.add_argument(
        "--basic", 
        action="store_true", 
        help="Use basic mode without enhanced path resolution"
    )
