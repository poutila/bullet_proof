...
from src.document_analysis.embeddings import analyze_active_document_similarities, analyze_semantic_similarity

# Import markdown analyzer if available
from src.document_analysis.markdown_analyzer import MarkdownAnalyzer, compare_markdown_blocks
